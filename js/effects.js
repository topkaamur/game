...
(function (Game) {
  ...
  Game.showConfetti = showConfetti;
  Game.showLoseEffect = showLoseEffect;
  Game.initBackgroundParticles = initBackgroundParticles;
  Game.showSuccessRound = showSuccessRound;
